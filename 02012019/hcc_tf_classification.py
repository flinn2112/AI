...
#    (train_x, train_y), (test_x, test_y) = iris_data.load_data()
    train_x = hcc_trainData.m_tData
    train_y = hcc_trainResult.m_tData
    test_x  = hcc_testData.m_tData
    test_y  = hcc_testResult.m_tData

    # Feature columns describe how to use the input.
    
    
    
    my_feature_columns = [tf.feature_column.numeric_column(key='image',shape=(24,))]
...
#        n_classes=5)
    ...
    classifier = tf.estimator.DNNClassifier([24,1000],n_classes=5,feature_columns=my_feature_columns)

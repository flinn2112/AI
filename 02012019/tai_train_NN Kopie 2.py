...
hcc_trainData   = hcc_utils.acmeEnv('xTrain_TwoCubesCylinder375-24.csv')
hcc_trainResult = hcc_utils.acmeEnv('triageTrainingResults.csv')
hcc_testData    = hcc_utils.acmeEnv('xTest_TwoCubesCylinder300-24.csv')
hcc_testResult  = hcc_utils.acmeEnv('triageTestResults.csv')
...
yTrain= loadtxt('triageTrainingResults.csv')
...
yTest= loadtxt('triageTestResults.csv')

# Step 3: Definition der Lernparameter
learning_rate = 0.001
num_epochs = 250
num_examples= xTrain.shape[0]
print('Anzahl der Trainingdaten: 'v+ repr(hcc_trainData.m_tData.shape[0]))
print('Anzahl der Testdaten: '    v+ repr(hcc_testData.m_tData.shape[0]))
